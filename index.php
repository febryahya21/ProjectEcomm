...
if (!$conn) {
  ...
  require_once 'header.php';
    ...
    <div class="container mt-5">
      ...
      <img src="sony.jpg" alt="Sonny Experia 5" width="200" height="200">
      <img src="appel.jpg" alt="Appel 11Pro Max" width="200" height="200">
      <img src="Samsung.jpg" alt="Samsung 21 Ultra" width="200" height="200">
      <img src="appel.jpg" alt="Appel 12Pro Max" width="200" height="200">
      <table class="table">
        ...
        <a href="laporan.php"><button class="btn btn-danger">Lihat Laporan barang</button></a>
      </div>
